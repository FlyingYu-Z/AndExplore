...
-keep public class beingyi.app.activity.**{*;}
-keep public class beingyi.app.ui.**{*;}
-keep public class beingyi.app.application.**{*;}
-keep public class beingyi.app.crash.**{*;}
...
-keep class com.bigzhao.** {*;}
-keep class jadx.** {*;}
-keep class com.beingyi.app.AE.bean.** {*;}
