...
public class BTagNode extends BXMLNode {
	...
	public void readEnd(IntReader reader) throws IOException{
		...
		if((ns_uri != mRawNSUri) || (name != mRawName) ){
			throw new IOException(BASE128.decode("XZpoBMDUgn6EeFvjUNXF4cS6TVCzTNuDe0ZiPrA8oeY="));
		}
	}
	...
	public static class Attribute {
		...
		public void setString(int str){
			if((mType>>24) != TypedValue.TYPE_STRING){
				throw new RuntimeException(BASE128.decode("cVURxvKc5rW5FDKXYxPD2QhCNtB078lIbzu2hNCKTDPxCBez5DnD21EswE7JzBAN"));
			}
		...
		public String toString() {
			return BASE128.decode("d41UrBRhaxuGSopjWQrIaQ==") +
					BASE128.decode("9iUleDFm+cHRBdD4p9K1Xg==") + mNameSpace +
					BASE128.decode("ml9P9zNCjSL7S1I9HcOJRQ==") + mName +
					BASE128.decode("I79FgtEvWGYXmUjW+2GkKw==") + mString +
					BASE128.decode("acnU6wj5H6InPULZ1+GOSg==") + mType +
					BASE128.decode("LD0hT7SV2dz+6OaAwz8maw==") + mValue +
					'}';
		}
	}
	...
	private int[] subArray(int[] src, int start, int len){
		if((start + len) > src.length ){
			throw new RuntimeException(BASE128.decode("UyJHvUBl7tJW0NgQnJGOxQ=="));
		}
