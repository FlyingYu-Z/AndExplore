...
public class AppManager extends baseDialog implements View.OnClickListener{
    ...
    public AppManager(Context mContext, int mWindow, String mPath) {
        ...
        dialog = new AlertDialog.Builder(context)
                .setTitle(BASE128.decode("plBSXxgqt1vLpfRh1oZPbQ=="))
                .setView(view)
                .setCancelable(true)
                ...
                new Thread(){
                    ...
                    public void run()
                    {
                        ...
                        try
                        {
                            ...
                            File outFile=new File(activity.getCuPath(),APKUtils.getLabel(context,path)+BASE128.decode("9wphzVfcegbjwNAGjcJYMw==")+APKUtils.getVersionName(context,path)+BASE128.decode("6ATRmqaRZDN1uwz9jSj3Sw=="));
                            ...
                            activity.runOnUiThread(new Runnable(){
                                ...
                                public void run()
                                {
                                    activity.showToast(BASE128.decode("97fzlL68KybY9NxPx6tYKQ=="));
    ...
    private void setUnderLinetransparent(SearchView searchView){
        try {
            ...
            Field ownField = argClass.getDeclaredField(BASE128.decode("SgNmTWYBv3HnVWK4QPK6uA=="));
    ...
    public void onClick(View view) {
        ...
        if (i == R.id.view_app_manager_TextView_left) {
            if (state.equals(BASE128.decode("Mtu+RIbERa19dCVQhKuOrg=="))) {
                ...
                state = BASE128.decode("FzrznU3UuD8KQAiBS9XCeA==");
            } else {
                ...
                state = BASE128.decode("Mtu+RIbERa19dCVQhKuOrg==");
            }


        } else if (i == R.id.view_app_manager_TextView_right) {
            if (state.equals(BASE128.decode("unoMCWlJ1en2ibSuHvWDsg=="))) {
                frame1.setVisibility(View.VISIBLE);
                frame2.setVisibility(View.VISIBLE);
                swiperereshlayout1.setVisibility(View.VISIBLE);
                swiperereshlayout2.setVisibility(View.VISIBLE);
                ...
                frame2.setVisibility(View.VISIBLE);
                swiperereshlayout2.setVisibility(View.VISIBLE);
                state = BASE128.decode("unoMCWlJ1en2ibSuHvWDsg==");
            }
