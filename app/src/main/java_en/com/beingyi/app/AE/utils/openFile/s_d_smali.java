                ...
                public boolean onMenuItemClick(MenuItem item)
                {
                    ...
                    switch (id)
                    {
                        ...
                        case R.id.action_dir_smali_toDex:
                            ...
                            final File outFile = new File(new File(Path).getAbsolutePath() + BASE128.decode("DTIyvVuENygDCzUKMfV5bg=="));
            ...
            public void run()
            {
                ...
                try
                {
                    ...
                    activity.runOnUiThread(new Runnable(){
                            ...
                            public void run()
                            {
                                activity.showToast(BASE128.decode("HnnXc97Hy9EummMbq+oWVA=="));
                                adapter.refresh();
