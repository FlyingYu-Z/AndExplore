  ...
  implements DataInput
{
  ...
  public void skipCheckInt(int expected) throws IOException {
    int got = readInt();
    if (got != expected)
      throw new IOException(String.format(BASE128.decode("pZsitGKBEcse/T2r0666aZy8B1ZfVbWY6rYhS4p8mG4="), new Object[] { Integer.valueOf(expected), Integer.valueOf(got) }));
  }
    ...
    throws IOException
  {
    short got = readShort();
    if (got != expected)
      throw new IOException(String.format(BASE128.decode("pZsitGKBEcse/T2r0666aZy8B1ZfVbWY6rYhS4p8mG4="), new Object[] { Short.valueOf(expected), Short.valueOf(got) }));
  }
    ...
    throws IOException
  {
    byte got = readByte();
    if (got != expected)
      throw new IOException(String.format(BASE128.decode("pZsitGKBEcse/T2r0666aZy8B1ZfVbWY6rYhS4p8mG4="), new Object[] { Byte.valueOf(expected), Byte.valueOf(got) }));
  }
