    ...
    private void showSystemPermissionsSettingDialog(final Activity context) {
        ...
        if (mPermissionDialog == null) {
            mPermissionDialog = new AlertDialog.Builder(context)
                .setMessage(BASE128.decode("WR9Or+3NPbgofMt3fQmhyB0JfAojuZjpDRQq0RLQ7CFV3kzy1qrJTSxaU633JvXI"))
                .setPositiveButton(BASE128.decode("I1ipUKJhBhRob+O6FsuIQw=="), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        cancelPermissionDialog();

                        Uri packageURI = Uri.parse(BASE128.decode("XABdxsFtgRKE3lZ994VNcQ==") + mPackName);
