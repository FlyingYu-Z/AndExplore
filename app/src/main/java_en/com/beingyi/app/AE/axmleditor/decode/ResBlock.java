...
public class ResBlock implements IAXMLSerialize{
	...
	public void print(){
		...
		for(int id : getResourceIds()){
			sb.append(id);
			sb.append(BASE128.decode("Pj8ZNlHIJ/Iq78bmhIjsOg=="));
		}
	...
	public void read(IntReader reader) throws IOException{
		...
		if(mChunkSize < 8 || (mChunkSize % 4)!= 0){
			throw new IOException(BASE128.decode("33pWYzseQ8+pi76NE6z0JhGzj7hm9We7QnQrFCm9Va8=")+mChunkSize+BASE128.decode("+I++SM5+Sxt809VvdXXalw=="));
		}
