...
public class enApkString extends baseDialog {
    ...
    public enApkString(Context mContext, int mWindow, String mPath) {
        ...
        dialog = new AlertDialog.Builder(context)
                .setTitle(BASE128.decode("Zg+/CJIqFbwpDmjqVwB2bn8c4T+lOARBWAhEIe4uC2A="))
                .setView(view)
                .setCancelable(false)
                ...
                .setPositiveButton(BASE128.decode("GXe18lf7nDG5Ik/56BTUhw=="), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        final File outFile = new File(new File(Path).getParent(), FileUtils.getPrefix(Path) + BASE128.decode("jtwE+9/TpPJZPjX3tU9NKg=="));
