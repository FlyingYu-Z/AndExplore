...
import com.beingyi.app.AE.axmleditor.utils.Pair;
...
public class BXMLTree implements IAXMLSerialize{
	...
	public void read(IntReader reader) throws IOException{
		...
		int chunkType;
			...
			case TEXT:
			{
				System.out.println(BASE128.decode("7zlCDJcKq0qGYDzVEXmpxQ=="));
		...
		if( !mRoot.equals(mVisitor.pop())){
			throw new IOException(BASE128.decode("QmA45zGDR10FSJ6YnoEHXq3g/N/Egg2Wo3SJEbKZfZQ="));
		}
