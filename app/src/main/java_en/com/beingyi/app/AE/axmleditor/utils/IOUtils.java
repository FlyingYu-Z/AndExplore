...
//        out.close();
    ...
    public static byte[] toByteArray(final InputStream input, final long size) throws IOException {
        ...
        if (size > Integer.MAX_VALUE) {
            throw new IllegalArgumentException(BASE128.decode("7hHLANRmuJjO7x8fe0Fv3kV14fxmgs33B7+jqcXXR+V8U5vnPctawjc2ffrr4Oxo") + size);
        }
    ...
    public static byte[] toByteArray(final InputStream input, final int size) throws IOException {
        ...
        if (size < 0) {
            throw new IllegalArgumentException(BASE128.decode("7lHqbo0uGEwRVx+k+3Z71NOO+DhsWuuZiP8gLybQOlSfsJ2Z6OXd5cwrTYZCrJk6") + size);
        }
        ...
        if (offset != size) {
            throw new IOException(BASE128.decode("EhY0A/tX363fKYfZ2lsa/lryD9HShqQ3FOUZTx3qtKE+Pxk2Ucgn8irvxuaEiOw6") + offset + BASE128.decode("mT4ESvBY2cWvTsE9AGU5hw==") + size);
        }
    ...
    public static long skip(final InputStream input, final long toSkip) throws IOException {
        if (toSkip < 0) {
            throw new IllegalArgumentException(BASE128.decode("k4laXPe6+awMZA5UnCHrlFDBoKJZCqKsKSLhEO9VT9lSNVd98mVijNSTH6oD6Srz") + toSkip);
        }
        /*
    ...
    public static void skipFully(final InputStream input, final long toSkip) throws IOException {
        if (toSkip < 0) {
            throw new IllegalArgumentException(BASE128.decode("b/+ClKISRLKHiY706SYh3t9R6uTBOrIKdeMqW/JosDPSyF/wS9q4Hd+c2o1HMz9N") + toSkip);
        }
        final long skipped = skip(input, toSkip);
        if (skipped != toSkip) {
            throw new EOFException(BASE128.decode("XW43PiFqf5vcv+juSLJSCg==") + toSkip + BASE128.decode("UjVXffJlYozUkx+qA+kq8w==") + skipped);
        }
    }
    ...
    public static void skipFully(final Reader input, final long toSkip) throws IOException {
        final long skipped = skip(input, toSkip);
        if (skipped != toSkip) {
            throw new EOFException(BASE128.decode("kED1OryzKINPMXMdPuVURg==") + toSkip + BASE128.decode("UjVXffJlYozUkx+qA+kq8w==") + skipped);
        }
    }
    ...
    public static int read(final Reader input, final char[] buffer, final int offset, final int length)
            throws IOException {
        if (length < 0) {
            throw new IllegalArgumentException(BASE128.decode("1BMtjjB0j3ZqAOJENnmrCjjqvtC/HsDTZFfN+uzpM8Q=") + length);
        }
    ...
    public static void readFully(final Reader input, final char[] buffer, final int offset, final int length)
        ...
        if (actual != length) {
            throw new EOFException(BASE128.decode("9BIuXGuiD8vmmmkGPERvzBc6851N1Lg/CkAIgUvVwng=") + length + BASE128.decode("UjVXffJlYozUkx+qA+kq8w==") + actual);
        }
    }
    ...
    public static void readFully(final ReadableByteChannel input, final ByteBuffer buffer) throws IOException {
        ...
        if (actual != expected) {
            throw new EOFException(BASE128.decode("9BIuXGuiD8vmmmkGPERvzBc6851N1Lg/CkAIgUvVwng=") + expected + BASE128.decode("UjVXffJlYozUkx+qA+kq8w==") + actual);
        }
    }
