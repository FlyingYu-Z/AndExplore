...
import com.beingyi.app.AE.axmleditor.decode.BTagNode;
import com.beingyi.app.AE.axmleditor.decode.BXMLNode;
import com.beingyi.app.AE.axmleditor.decode.StringBlock;
...
public class PackageInfoEditor extends BaseEditor<PackageInfoEditor.EditorInfo> {
    ...
    public static class EditorInfo {
        ...
        public String toString() {
            return BASE128.decode("Fxdxwvb106UeKRgkVXXq4A==") +
                    BASE128.decode("wrO8mSRhaUFVriKki6PweA==") + versionCode +
                    ", versionName='" + versionName + '\'' +
                    ", packageName='" + packageName + '\'' +
                    BASE128.decode("4z8KlCapMHyTWHhIrO3lXxc6851N1Lg/CkAIgUvVwng=") + verCode_Value +
                    BASE128.decode("AfOEHtejfAC9FtZOfItLIRc6851N1Lg/CkAIgUvVwng=") + verName_Value +
                    BASE128.decode("AURVTaOBJGS6LqtbaFh+6Rc6851N1Lg/CkAIgUvVwng=") + pkgName_Value +
                    BASE128.decode("owmTclj7UcyU5o4Yo6nbArpq6gg09Np1WXMgvxZT30I=") + verCodeHasEdit +
                    BASE128.decode("zx5geTRiw8QvgCVSVXrC07pq6gg09Np1WXMgvxZT30I=") + verNameHasEdit +
                    BASE128.decode("ns69KtGHJ5pfl0I38VeRK7pq6gg09Np1WXMgvxZT30I=") + pkgNameHasEdit +
                    '}';
        }
    }
}
