...
public class StringBlock
{
        ...
        throws IOException
    {
        ...
        int chunkSize =block.chunkSize=reader.readInt();
                System.out.println(BASE128.decode("qNtbwAOZXPDJZe7/I/eZIA==")+chunkSize);

        int stringCount = reader.readInt();
              System.out.println(BASE128.decode("tAgbRdqi5noX4/tKEgiJYA==")+stringCount);

        int styleOffsetCount =block.styleOffsetCount= reader.readInt();
            System.out.println(BASE128.decode("vofLWtIQuMep50iKiGpghD4/GTZRyCfyKu/G5oSI7Do=")+styleOffsetCount);

        int flags = block.flags = reader.readInt();

        int stringsOffset =block.stringsOffset= reader.readInt();
          System.out.println(BASE128.decode("onQEJyj6DU1e+FeabAuLiQ==")+stringsOffset);

        int stylesOffset =block.stylesOffset= reader.readInt();
        System.out.println(BASE128.decode("YMz/1uaVw2OQk5El7JPa0Q==")+stylesOffset);
        ...
        if (size % 4 != 0) {
            throw new IOException(BASE128.decode("GHeNbhCk5TdRu6v43fdiowEX57nRIiQaFdlNpDDIQja99kVsUL6h3Gnu+Yow4cOo") + size + BASE128.decode("+I++SM5+Sxt809VvdXXalw=="));
        }
        ...
        if (stylesOffset != 0) {
            ...
            if (size % 4 != 0) {
                throw new IOException(BASE128.decode("p0+4B7cuSJuhaoJCwOe7nBMuHdDcvCdGlf8sTMxgGOlxbvUIpaBCNn9IbXthxKtw") + size + BASE128.decode("+I++SM5+Sxt809VvdXXalw=="));
            }
            block.m_styles = reader.readIntArray(size / 4);
            System.out.println(BASE128.decode("UgluxIp61IYrvOYsf9vPEA==")+size);
        }
        System.out.println();
    ...
    public void write(List<String> list,LEDataOutputStream out)throws IOException{
        ...
        System.out.println(BASE128.decode("OE1+L59BoG8VYzpF/VZmG5WqPasxF4Pu+CQuHAOaxWs=")+chunkSize);
        ...
        if(styleOffsetCount!=0){
            System.out.println(BASE128.decode("DAL0Jc+Mbvr52fbWKui1Gxc+iyg9T80MMvAWSuESMDw="));
        ...
        if(m_styles!=null){
            System.out.println(BASE128.decode("jwDj2R3uOw/j4joLJlCyrA=="));
