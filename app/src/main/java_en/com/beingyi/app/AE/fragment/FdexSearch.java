...
public class FdexSearch extends BaseFragment implements ViewPager.OnPageChangeListener {
        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(getKeyWord().isEmpty()){
                    ToastUtils.show(BASE128.decode("NvKFrKqOlg+3lZMK5Sc0XUd1dbSf14Aim2sQUpyZ/zg="));
                    return;
                }
    ...
    private void initTab() {
        ...
        final TabLayout.Tab tab1 = tabLayout.newTab().setText(BASE128.decode("I/O+Mxfl8pBy41qXY7rNeQ=="));
        final TabLayout.Tab tab2 = tabLayout.newTab().setText(BASE128.decode("7h9PFDSFQublx+HPU3Hpyw=="));
        final TabLayout.Tab tab3 = tabLayout.newTab().setText(BASE128.decode("VdUNvB+OsIthIi0zJLpQTg=="));
        final TabLayout.Tab tab4 = tabLayout.newTab().setText(BASE128.decode("JzV+BK5DeH8zPXgHcvhIRg=="));
