...
public class APKUtils
{
    ...
    public static String getVersionName(Context context, String apkPath) {
        ...
        if (info != null) {
            ...
            appInfo.publicSourceDir = apkPath;
            try {
                return info.versionName==null?BASE128.decode("6DZ1PVWnXoHRL4kkqY+fzQ=="):info.versionName;
            } catch (OutOfMemoryError e) {
            }
        }
        return null;
    ...
    public static boolean installAPK(Context context, String path) {
        ...
        if (apkFile.exists()) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                Uri contentUri = FileProvider.getUriForFile(context, BASE128.decode("qTy0S6HzisSLDitZhdnyDLYR5CBsaD+VxzLEEjOuQszDTW8RWwjrqSpwfKA5mfeE"), apkFile);
                intent.setDataAndType(contentUri, BASE128.decode("HVyfc8yGeHIt6E3KP4FKKcvlBbqfimBwR5IpRinXMyLyBXHWDFNdcoV2+JBq2PyO"));
            } else {
                intent.setDataAndType(Uri.fromFile(apkFile), BASE128.decode("HVyfc8yGeHIt6E3KP4FKKcvlBbqfimBwR5IpRinXMyLyBXHWDFNdcoV2+JBq2PyO"));
