...
public class BaseActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
        int result = 0;
        int resourceId = context.getResources().getIdentifier(BASE128.decode("3Mu66Zs6IOu2905VOTaBgPpK8XSESAtRY5HYFova3AQ="), BASE128.decode("XZVkY7cejwr5FSPIpFkMmw=="), BASE128.decode("SG9fQp8kqGMXghNgWSPx5g=="));
        if (resourceId > 0)
        {
