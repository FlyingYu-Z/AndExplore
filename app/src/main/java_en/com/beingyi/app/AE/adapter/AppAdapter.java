...
public class AppAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.versionName.setText(BASE128.decode("HPaMchqudtXM0yPj2K0xcQ==") + appInfo.versionName);
        holder.packageName.setText(BASE128.decode("eUJ2FRi8iHOxC+8kB3gEHw==") + appInfo.size);
        if (appInfo.isBacked) {
            holder.isBacked.setText(BASE128.decode("Xl7Ffo03XZjaf3Vl3M6h3w=="));
        }
