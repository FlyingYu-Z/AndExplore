...
public class selectFile
{
    ...
    public selectFile(Context mContext, int windows, String mPath,String mSuffix,SelectFileCallBack mCallBack)
    {
        ...
        View header=lv_file.findViewWithTag(BASE128.decode("SMLdjkamg/ZL1fB4/sGvcQ=="));
        ...
        lv_file.setOnItemClickListener(new OnItemClickListener(){
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id)
                {
                    ...
                    if(!FileUtils.getSuffix(filePath).equals(suffix)){
                        ToastUtils.show(BASE128.decode("UUm2MzsqnsB+8FLdw7lxyX5AkDHBQOJgJoYFxRTiPvY=")+suffix+BASE128.decode("jDebEeroEi4J6bvneiM9Aw=="));
                        return;
                    }
         ...
         dialog = new AlertDialog.Builder(context)
            .setTitle(BASE128.decode("zRUkXyO9AsiB01wo8M2Dag=="))
            .setView(view)
            .setCancelable(false)
    ...
    public class FileAdapter extends BaseAdapter
    {
        ...
        public void getFiles(String dir)
        {
            ...
            try
            {
                ...
                {
                    String listMode=SPUtils.getString(context, BASE128.decode("W2pJPq03yxukoKDvS7KV3w=="), BASE128.decode("DVCOVY1gDmb+zezx+eoI6A==") + window);
                    Runtime mRuntime = Runtime.getRuntime();
                    //Process mProcess = mRuntime.exec("ls " + listMode + " " + dir);
                    Process mProcess = mRuntime.exec(BASE128.decode("0U8nCNWQCTlM8lViQg0Gtg==") + dir);
                    ...
                    if (!result.equals(BASE128.decode("FzrznU3UuD8KQAiBS9XCeA==")))
                    {
                        files = result.split("\n");
                    }
                }
        ...
        public void loadImage(Context context, FileAdapter adapter, final String mImageUrl, final Integer mt, final OnImageLoadListener mListener)
        {
            ...
            try
            {
                ...
                if (file.isFile())
                {
                    ...
                    else if (suffix.equals(BASE128.decode("3m8oJWeZo0IKRlsXf8e9DA==")) || suffix.equals(BASE128.decode("77q/pLYqCIj4QyskZ26SCg==")) || suffix.equals(BASE128.decode("pnWrCRPGzR7fVf5XLGFwsg==")) || suffix.equals(BASE128.decode("HnYqhiy/hQDpFVfK3Kudig==")))
                    {
