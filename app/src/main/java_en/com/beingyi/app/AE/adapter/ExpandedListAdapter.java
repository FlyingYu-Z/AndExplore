...
public class ExpandedListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        ExpandedListAdapter.SlideMenuInfo menuInfo = ((Map<String, ExpandedListAdapter.SlideMenuInfo>) getChild(groupPosition, childPosition)).get(BASE128.decode("vZ1SApSEcFlgkdMS6G1NLQ=="));
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        String text = groups.get(groupPosition).get(BASE128.decode("UubAzefLlePbZtWnRVXEvA=="));
        LayoutInflater layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        //获取一级列表布局文件,设置相应元素属性
