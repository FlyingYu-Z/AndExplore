                ...
                new Thread() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            zipTree.saveFile();
                            activity.showToast(MyApplication.getInstance().getString("562e6c6af7c01dc09d13e9cab6ecb8e5"));
    ...
    public void putToDir(FilesAdapter adapter, final String dir, final String Name) {
        ...
        if (cuType == 2) {
            ...
            new Thread() {
                @Override
                public void run() {
                    progres.setLabel(MyApplication.getInstance().getString("b8894f69104bc6f414501316aacd6e32"));
                    progres.setNoProgress();
                    progres.show();
                    try {
                        zipTree.extract(cuEntry, dir);

                        activity.showToast(MyApplication.getInstance().getString("3b29f381c79aad9b556a93c1b5214801"));
                        activity.refreshList();
