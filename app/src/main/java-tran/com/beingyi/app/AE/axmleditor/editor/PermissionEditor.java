            ...
            if(opera.isRemove()){
                ...
                while (iterator.hasNext()){
                    ...
                    if((user_permission == n.getName()) && (n.getAttrStringForKey(attr_name) == opera.permissionValue_Index)){
                        System.out.println(MyApplication.getInstance().getString("58133abdedc9e693a77c1b4c1af90b4c") + opera.permission);
                        iterator.remove();
                ...
                System.out.println(MyApplication.getInstance().getString("32eb662e99e3a28d1e80677976128dfb")+opera.permission);
