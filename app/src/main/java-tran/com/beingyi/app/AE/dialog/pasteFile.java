...
public class pasteFile
{
    ...
    public pasteFile(Context mContext, int windows,boolean mHideRename)
    {
        ...
        {
            tv_destDir.setText(adapter.zipTree.Path + "/" + adapter.zipTree.tree.getCurPath());
        }
    ...
    private void checkExists(){
        ...
        if(file.exists()){
            btn_ok.setText(MyApplication.getInstance().getString("e09fea40f7e4abd4b2a495b315940688"));
        }else{
            btn_ok.setText(MyApplication.getInstance().getString("38cf16f2204ffab8a6e0187070558721"));
        }
