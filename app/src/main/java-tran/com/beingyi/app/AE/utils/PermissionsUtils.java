    ...
    private void showSystemPermissionsSettingDialog(final Activity context) {
        ...
        if (mPermissionDialog == null) {
            mPermissionDialog = new AlertDialog.Builder(context)
                .setMessage(MyApplication.getInstance().getString("3d64875b7dfaa54d6ded9e784d75c9ae"))
                .setPositiveButton(MyApplication.getInstance().getString("e366ccf1556c0672dcecba135ed5472e"), new DialogInterface.OnClickListener() {
                    @Override
