...
public class enDexString extends baseDialog {
    ...
    public enDexString(Context mContext, int mWindow, String mPath) {
        ...
        dialog = new AlertDialog.Builder(context)
                .setTitle(MyApplication.getInstance().getString("2f29b9525b9e0eb8c7fce0aafca3d808"))
                .setView(view)
                .setCancelable(false)
                ...
                .setPositiveButton(MyApplication.getInstance().getString("38cf16f2204ffab8a6e0187070558721"), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        final File outFile = new File(new File(Path).getParent(), FileUtils.getPrefix(Path) + "_enStr.dex");
