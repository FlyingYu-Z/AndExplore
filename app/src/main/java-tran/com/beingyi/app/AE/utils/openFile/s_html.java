...
public class s_html extends s_base {
    ...
    public s_html(Context mContext, int mWindow, String mPath, View view, boolean mIsInZip) {
        ...
        popupMenu.getMenu().add(1, 1, 1, MyApplication.getInstance().getString("9c5c5cdbc52718a78ddcba9d88aea253"));
        popupMenu.getMenu().add(2, 2, 2, MyApplication.getInstance().getString("95b351c86267f3aedf89520959bce689"));
        popupMenu.show();
