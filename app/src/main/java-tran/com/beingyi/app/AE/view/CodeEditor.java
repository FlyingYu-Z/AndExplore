...
public class CodeEditor extends FreeScrollingTextField {
    ...
    public void startGotoMode() {
        ...
        startActionMode(new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                // TODO: Implement this method
                mode.setTitle(MyApplication.getInstance().getString("2ee547f0d6d17daa1b5edcc7644816fd"));
    ...
    public void startFindMode() {
        ...
        startActionMode(new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                // TODO: Implement this method
                mode.setTitle(MyApplication.getInstance().getString("e5f71fc31e7246dd6ccc5539570471b0"));
                mode.setSubtitle(null);
            ...
            private void findNext() {
                ...
                if (idx == -1) {
                    selectText(false);
                    Toast.makeText(mContext, MyApplication.getInstance().getString("c465be75dc6eb8e03eff2018f7ba11f8"), Toast.LENGTH_SHORT).show();
                    idx = 0;
                    return;
                }
    ...
    public boolean findUp(String keyword) {
        ...
        if (kw.isEmpty()) {
            selectText(false);
            Toast.makeText(mContext, MyApplication.getInstance().getString("80bbb382aade66f432b436fed815d148"), Toast.LENGTH_SHORT).show();
            return false;
        }
