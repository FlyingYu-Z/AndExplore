...
public class AppManager extends baseDialog implements View.OnClickListener{
    ...
    public AppManager(Context mContext, int mWindow, String mPath) {
        ...
        dialog = new AlertDialog.Builder(context)
                .setTitle(MyApplication.getInstance().getString("8405e7a4119bc15a0383ea64518f52e6"))
                .setView(view)
                .setCancelable(true)
                    ...
                    public void run()
                    {
                        ...
                        try
                        {
                            ...
                            activity.runOnUiThread(new Runnable(){
                                ...
                                public void run()
                                {
                                    activity.showToast(MyApplication.getInstance().getString("1b3ec4a7baafb6ad9cd482ee5b010fe2"));
