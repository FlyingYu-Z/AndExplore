                            ...
                            new getSavePath(context, window, outFile.getAbsolutePath(), new GetSavePathCallBack(){
                                    ...
                                    public void onSuccess(String filePath)
                                    {
                                        try
                                        {
                                            ...
                                            ToastUtils.show(MyApplication.getInstance().getString("0bef1e1ff6bb00fc472dc6bb442ff1f6"));
                                            adapter.refresh();
                            ...
                            new getSavePath(context, window, outFile.getAbsolutePath(), new GetSavePathCallBack(){
                                    ...
                                    public void onSuccess(String filePath)
                                    {
                                        ...
                                        try
                                        {
                                            ...
                                            ToastUtils.show(MyApplication.getInstance().getString("8fd28a257a61025496d6b2b704212562"));
                                            adapter.refresh();
