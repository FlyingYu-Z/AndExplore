...
import com.beingyi.app.AE.application.MyApplication;import com.google.common.collect.Lists;
...
public class dealDEX
{
    ...
    public dealDEX(SuperEncryption mSuperEncryption, String customApplicationName , List<String> activitis, byte[] dexByte) throws Exception
    {
        ...
        for (int i=0;i < dexBackedClassDef.size();i++)
        {
            ...
            {
                System.out.println(MyApplication.getInstance().getString("f253b3b4e509dbb6209b5312a9323436")+typePkg);
            ...
            else if (typePkg.equals(customApplicationName))
            {
                ...
                System.out.println(MyApplication.getInstance().getString("70f1b64decfe70a04c7ee5893982e3a3"));
            }
            else
            {
