 ...
 *
 */
public class MyStringBlock {
	
	/**
	 * Reads whole (including chunk type) string block from stream.
	 * Stream must be at the chunk type.
	 */
	public static MyStringBlock read(IntReader reader) throws IOException {
		...
		MyStringBlock block=new MyStringBlock();
