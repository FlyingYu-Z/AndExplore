...
public class FdexSearch extends BaseFragment implements ViewPager.OnPageChangeListener {
    ...
    private void initTab() {
        ...
        final TabLayout.Tab tab1 = tabLayout.newTab().setText("类");
        final TabLayout.Tab tab2 = tabLayout.newTab().setText("方法");
        final TabLayout.Tab tab3 = tabLayout.newTab().setText("代码");
        final TabLayout.Tab tab4 = tabLayout.newTab().setText("字符串");
