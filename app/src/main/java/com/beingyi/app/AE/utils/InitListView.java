...
import com.beingyi.app.AE.activity.ArscEditor.ArscEditorActivity;
    ...
    public void openFile(File file, View view, boolean isInZip) {
        ...
        if (file.isDirectory()) {
            ...
            if(suffix.equals("arsc")){
                //context.startActivity(new Intent(context, ArscEditorActivity.class).putExtra("Path",file.getAbsolutePath()));
                return;
            }
